function harmonic_oscillator_semi_implicit_euler()
  ...
  for i=1:N-1
    y(:,i+1) = semi_implicit_euler_step(y(:,i), t(i), deltat);
  ...
  xlabel('time')
  ylabel('position')
  title('Position vs. time -- semi-implicit Euler')
  ...
  xlabel('time')
  ylabel('energy')
  title('Energy vs. time -- semi-implicit Euler')
  axis([0, Tend, 0, 5])
